...
#SBATCH --output="logs/SimGCD_CIFAR100_mp.log"
#SBATCH --job-name="SimGCD_CIFAR100_mp"
...
outfile="logs/SimGCD_CIFAR100_mp.out"
#errfile="logs/SimGCD_CIFAR100_mp.err"
