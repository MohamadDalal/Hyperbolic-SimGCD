...
#SBATCH --output="logs/SimGCD-CUB-Hyperbolic-Poincare-Original.log"
#SBATCH --job-name="SimGCD-CUB-Hyperbolic-Poincare-Original"
#SBATCH --time=12:00:00
#SBATCH --signal=B:SIGTERM@30
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-gpu=8
#SBATCH --mem=16G
#SBATCH --nodelist=ailab-l4-11
...
outfile="logs/SimGCD-CUB-Hyperbolic-Poincare-Original.out"

exp_id="SimGCD-CUB-Hyperbolic-Poincare-Original"
...
srun --output="${outfile}" --error="${outfile}" singularity exec --nv ${container_path} ${PYTHON} train.py \
            ...
            --avg_grad_norm 0.25 \
            --use_dinov2 \
            --checkpoint_path '/ceph/home/student.aau.dk/mdalal20/P10-project/Hyperbolic-SimGCD/dev_outputs/simgcd/log/CUB-Hyperbolic-Train-Poincare-Original/checkpoints/model.pt'
