...
#SBATCH --output="logs/SimGCD-Test-SCars.log"
#SBATCH --job-name="SimGCD-Test-SCars"
...
outfile="logs/SimGCD-Test-SCars.out"

exp_id="SimGCD-Test-SCars"
...
srun --output="${outfile}" --error="${outfile}" singularity exec --nv ${container_path} ${PYTHON} test.py \
            ...
            --eval_funcs 'v2' \
            --use_dinov2 \
            --checkpoint_path '/ceph/home/student.aau.dk/mdalal20/P10-project/Hyperbolic-SimGCD/dev_outputs/simgcd/log/SimGCD-SCars/checkpoints/model_best_loss.pt'
