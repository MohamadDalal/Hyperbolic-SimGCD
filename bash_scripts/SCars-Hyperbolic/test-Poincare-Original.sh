...
#SBATCH --output="logs/SimGCD-Test-SCars-Hyperbolic-Poincare-Original.log"
#SBATCH --job-name="SimGCD-Test-SCars-Hyperbolic-Poincare-Original"
...
outfile="logs/SimGCD-Test-SCars-Hyperbolic-Poincare-Original.out"

exp_id="SimGCD-Test-SCars-Hyperbolic-Poincare-Original"
...
srun --output="${outfile}" --error="${outfile}" singularity exec --nv ${container_path} ${PYTHON} test.py \
            ...
            --lr 0.1 \
            --eval_funcs 'v2' \
            --exp_id 'SCars-Hyperbolic-Train-Poincare-Original' \
            --hyperbolic \
            --poincare \
            --original_poincare_layer \
            --euclidean_clipping 2.3 \
            --use_dinov2 \
            --checkpoint_path '/ceph/home/student.aau.dk/mdalal20/P10-project/Hyperbolic-SimGCD/dev_outputs/simgcd/log/SCars-Hyperbolic-Train-Poincare-Original/checkpoints/model_best_loss.pt'
