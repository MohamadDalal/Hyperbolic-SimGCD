...
#SBATCH --output="logs/SimGCD-SCars-Hyperbolic-Poincare.log"
#SBATCH --job-name="SimGCD-SCars-Hyperbolic-Poincare"
#SBATCH --time=12:00:00
#SBATCH --signal=B:SIGTERM@30
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-gpu=8
#SBATCH --mem=16G
#SBATCH --nodelist=ailab-l4-03
...
outfile="logs/SimGCD-SCars-Hyperbolic-Poincare.out"

exp_id="SimGCD-SCars-Hyperbolic-Poincare"
