...
#SBATCH --output="logs/SimGCD-SCars-Hyperbolic.log"
#SBATCH --job-name="SimGCD-SCars-Hyperbolic"
...
outfile="logs/SimGCD-SCars-Hyperbolic.out"

exp_id="SimGCD-SCars-Hyperbolic"
