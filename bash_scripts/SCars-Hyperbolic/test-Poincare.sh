...
#SBATCH --output="logs/SimGCD-Test-SCars-Hyperbolic-Poincare.log"
#SBATCH --job-name="SimGCD-Test-SCars-Hyperbolic-Poincare"
...
outfile="logs/SimGCD-Test-SCars-Hyperbolic-Poincare.out"

exp_id="SimGCD-Test-SCars-Hyperbolic-Poincare"
...
srun --output="${outfile}" --error="${outfile}" singularity exec --nv ${container_path} ${PYTHON} test.py \
            ...
            --lr 0.1 \
            --eval_funcs 'v2' \
            --exp_id 'SCars-Hyperbolic-Train-Poincare' \
            --hyperbolic \
            --poincare \
            --euclidean_clipping 2.3 \
            --use_dinov2 \
            --checkpoint_path '/ceph/home/student.aau.dk/mdalal20/P10-project/Hyperbolic-SimGCD/dev_outputs/simgcd/log/SCars-Hyperbolic-Train-Poincare/checkpoints/model_best_loss.pt'
