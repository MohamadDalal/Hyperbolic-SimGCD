...
#SBATCH --output="logs/SimGCD-Test-Aircraft-Hyperbolic.log"
#SBATCH --job-name="SimGCD-Test-Aircraft-Hyperbolic"
...
outfile="logs/SimGCD-Test-Aircraft-Hyperbolic.out"

exp_id="SimGCD-Test-Aircraft-Hyperbolic"
...
srun --output="${outfile}" --error="${outfile}" singularity exec --nv ${container_path} ${PYTHON} test.py \
            ...
            --use_dinov2 \
            --checkpoint_path '/ceph/home/student.aau.dk/mdalal20/P10-project/Hyperbolic-SimGCD/dev_outputs/simgcd/log/Aircraft-Hyperbolic-Train/checkpoints/model_best_loss.pt'
