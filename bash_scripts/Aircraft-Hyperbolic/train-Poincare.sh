...
#SBATCH --output="logs/SimGCD-Aircraft-Hyperbolic-Poincare.log"
#SBATCH --job-name="SimGCD-Aircraft-Hyperbolic-Poincare"
#SBATCH --time=12:00:00
#SBATCH --signal=B:SIGTERM@30
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-gpu=8
#SBATCH --mem=16G
#SBATCH --nodelist=ailab-l4-08
...
outfile="logs/SimGCD-Aircraft-Hyperbolic-Poincare.out"

exp_id="SimGCD-Aircraft-Hyperbolic-Poincare"
...
srun --output="${outfile}" --error="${outfile}" singularity exec --nv ${container_path} ${PYTHON} train.py \
            ...
            --avg_grad_norm 0.25 \
            --use_dinov2 \
            --checkpoint_path '/ceph/home/student.aau.dk/mdalal20/P10-project/Hyperbolic-SimGCD/dev_outputs/simgcd/log/Aircraft-Hyperbolic-Train-Poincare/checkpoints/model.pt'
