...
#SBATCH --output="logs/SimGCD-Aircraft-Hyperbolic.log"
#SBATCH --job-name="SimGCD-Aircraft-Hyperbolic"
...
outfile="logs/SimGCD-Aircraft-Hyperbolic.out"

exp_id="SimGCD-Aircraft-Hyperbolic"
