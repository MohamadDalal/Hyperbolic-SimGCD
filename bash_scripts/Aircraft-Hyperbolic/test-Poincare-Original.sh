...
#SBATCH --output="logs/SimGCD-Test-Aircraft-Hyperbolic-Poincare-Original.log"
#SBATCH --job-name="SimGCD-Test-Aircraft-Hyperbolic-Poincare-Original"
...
outfile="logs/SimGCD-Test-Aircraft-Hyperbolic-Poincare-Original.out"

exp_id="SimGCD-Test-Aircraft-Hyperbolic-Poincare-Original"
...
srun --output="${outfile}" --error="${outfile}" singularity exec --nv ${container_path} ${PYTHON} test.py \
            ...
            --use_dinov2 \
            --checkpoint_path '/ceph/home/student.aau.dk/mdalal20/P10-project/Hyperbolic-SimGCD/dev_outputs/simgcd/log/Aircraft-Hyperbolic-Train-Poincare-Original/checkpoints/model_best_loss.pt'
